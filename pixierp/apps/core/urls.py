...
urlpatterns = [
    ...
    path('menu-badges/', views.menu_badges_view, name='menu_badges'),
    path('record-seen/', views.record_seen_view, name='record_seen'),
    path('page-visit/', views.page_visit_view, name='page_visit'),
    ...
    path('public-site/portal/admin-login/', views.ClientPortalAdminLoginView.as_view(), name='client-portal-admin-login'),
    path('public-site/portal/search-users/', views.ClientPortalUserSearchView.as_view(), name='client-portal-search-users'),
    path('public-site/portal/print-presets/', views.PortalPrintPresetsView.as_view(), name='portal-print-presets'),
    path('public-site/portal/calculate-price/', views.PortalCalculatePriceView.as_view(), name='portal-calculate-price'),
    ...
    path('public-site/portal/magic-link/', views.ClientPortalMagicLinkView.as_view(), name='client-portal-magic-link'),
    path('public-site/portal/magic-login/', views.ClientPortalMagicLoginView.as_view(), name='client-portal-magic-login'),
    path('public-site/portal/qr-create/', views.ClientPortalQRCreateView.as_view(), name='client-portal-qr-create'),
    path('public-site/portal/qr-poll/', views.ClientPortalQRPollView.as_view(), name='client-portal-qr-poll'),
    path('public-site/portal/forgot-password/', views.ClientPortalForgotPasswordView.as_view(), name='client-portal-forgot-password'),
    ...
    path('i18n/translate/', views.translate_texts_view, name='translate-texts'),
    path('i18n/languages/', views.supported_languages_view, name='supported-languages'),
    path('i18n/translations/', views.all_translations_view, name='all-translations'),
    path('i18n/source-strings/', views.source_strings_view, name='source-strings'),
    path('i18n/entries/', views.translation_entries_view, name='translation-entries'),
    path('i18n/entry/', views.update_translation_view, name='update-translation'),
    path('public-cart-quote/', views.portal_cart_quote_view, name='public-cart-quote'),
]