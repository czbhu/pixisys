...
urlpatterns = [
    ...
    path('quote-requests/public/<str:token>/items/<int:item_id>/attachments/upload/', views.public_upload_item_attachment, name='rfq_public_upload_item_attachment'),
    path('quote-requests/public/<str:token>/items/<int:item_id>/attachments/<int:att_id>/delete/', views.public_delete_item_attachment, name='rfq_public_delete_item_attachment'),
