...
class MaterialRemnant(models.Model):
    ...
    material = models.ForeignKey(
        Material, on_delete=models.CASCADE, related_name='remnants', verbose_name="Alapanyag"
    )
    warehouse = models.ForeignKey(
        Warehouse, on_delete=models.SET_NULL, null=True, blank=True,
        related_name='remnants', verbose_name="Raktár"
    )
    source_stock = models.ForeignKey(
        'MaterialStock', on_delete=models.SET_NULL, null=True, blank=True,
        related_name='remnants', verbose_name="Forrás készlet"
    )
    created_by = models.ForeignKey(
        'auth.User', on_delete=models.SET_NULL, null=True, blank=True,
        related_name='created_remnants', verbose_name="Létrehozó"
    )
    quantity = models.DecimalField(max_digits=12, decimal_places=4, default=0, verbose_name="Mennyiség")
    unit = models.CharField(max_length=20, blank=True, verbose_name="Mértékegység")
