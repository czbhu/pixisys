...
from invoices.views.nav_api_views import token_exchange, test_nav_connection, lookup_taxpayer, get_exchange_rate, menu_badge_counts, menu_badge_counts, menu_badge_counts
...
urlpatterns = [
    ...
    path('api/menu-badges/', menu_badge_counts, name='menu_badge_counts'),
