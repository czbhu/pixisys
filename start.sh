...
if [ "$PRODUCTION_MODE" != "true" ]; then
    ...
    PORT=3000 BROWSER=none HOST=0.0.0.0 DANGEROUSLY_DISABLE_HOST_CHECK=true WDS_SOCKET_PORT=0 WDS_SOCKET_PATH=/wds-hmr REACT_APP_API_URL=/api/v1 REACT_APP_DEV_MODE=true npm start > /tmp/pixierp_frontend.log 2>&1 &
    ERP_FRONTEND_PID=$!
